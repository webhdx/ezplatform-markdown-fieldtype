...
namespace EzSystems\MarkdownFieldTypeBundle\DependencyInjection;
 ...
 */
class EzSystemsMarkdownFieldTypeExtension extends Extension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->prependFieldTemplates($container);
        $this->prependYui($container);
        $this->prependCss($container);
    }

    private function prependFieldTemplates(ContainerBuilder $container)
    {
    ...
    private function prependYui(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ez_platformui.fieldtype.markdown.public_dir', 'bundles/ezsystemsmarkdownfieldtype');
